...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ENCOM一号机', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '什么都玩一点', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ja-307020.top', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/4466054', // B站主页
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9522234355', // 对应歌单的 id
